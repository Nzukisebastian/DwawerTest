...
import com.example.dwawertest.SubjectCategories.GalleryActivity;
import com.example.dwawertest.SubscribeScreen.Mpesa_Pay;
import com.example.dwawertest.activity.MainActivity;
...
public class Backgroundtask extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... params) {
        type = params[0];
        String login_url = "https://mtaani-academy.co.ke/mtaani/login.php";
        String register_url ="https://mtaani-academy.co.ke/mtaani/register.php";
    ...
    protected void onPostExecute(String result) {
        ...
        if(result!=null && result.equals("login success")){
           ...
           // i.putExtra("emailid",email);
            ...
            Toast.makeText(context,result,Toast.LENGTH_LONG).show();
            Intent i=new Intent(context,Mpesa_Pay.class);
            context.startActivity(i);
        }
