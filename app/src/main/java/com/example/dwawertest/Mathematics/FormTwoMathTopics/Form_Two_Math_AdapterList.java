...
public class Form_Two_Math_AdapterList extends RecyclerView.Adapter<Form_Two_Math_AdapterList.HolderItem> {

  List<Form_Two_Math_Model> mListItem;
  Context context;
  public Form_Two_Math_AdapterList(List<Form_Two_Math_Model> mListItem, Context context) {
  ...
  @Override
  public void onBindViewHolder(final HolderItem holder, final int position) {final Form_Two_Math_Model mlist=mListItem.get(position);
